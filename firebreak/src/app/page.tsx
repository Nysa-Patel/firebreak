...
// AQI/trend/clean-air data) is already in the initial HTML -- a live demo
// on unfamiliar wifi, or a cold Render backend, shouldn't have to sit on a
// loading skeleton for its most important screen. Client-side fetching
